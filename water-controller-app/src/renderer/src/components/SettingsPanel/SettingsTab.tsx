...
export function SettingsTab({
  ...
  const [testErrorDialogVisible, setTestErrorDialogVisible] = useState(false)
  ...
  return (
        ...
        <div className="card-body p-5 space-y-4">
            ...
            <label className="label cursor-pointer justify-start gap-3 py-2">
              ...
              <div className="flex-1">
                ...
                <p className="text-base opacity-60 mt-0.5">
                  ...
                  <br />
                  ショートカット: <kbd className="kbd">Cmd</kbd> +{' '}
          ...
          <div>
            ...
            <button
              ...
              onClick={() => setTestErrorDialogVisible(true)}
            >
              エラーダイアログのテスト
            </button>
          </div>
    ...
    {/* テスト用エラーダイアログ */}
    {testErrorDialogVisible && (
      <ErrorDialog
        message="これはテスト用のエラーダイアログです"
        details="詳細情報をここに表示できます。\n複数行のテキストも表示可能です。"
        onClose={() => setTestErrorDialogVisible(false)}
      />
    )}
    </>
  )
